...
companies = ['Ford', 'JetBlue', 'eBay', 'Target', 'Abbott', 'Oracle','HP', 'Verizon', 'Procter', 'UPS', 'WellPoint', 'AMD', 'Staples', 'Microsoft', 'Pfizer', 'Emerson', 'Pepsi', 'AT&T', 'Celgene Corporation', 'ARAMARK', 'IBM', 'Starbucks', 'Cisco', 'Marriott', 'Apple', 'AMR', 'GE', 'Citi', 'Boeing', 'Sprint', 'Symantec', 'JP', 'Morgan', 'Harley', 'Davidson', 'Amex', 'MasterCard', 'Caterpillar', 'Southwest', 'Xerox', '3M', 'Disney', 'Lockheed', 'GM', 'Honeywell', 'Northrop', 'Grumman', 'Dell', 'Yahoo!', 'Allstate', 'Merck', 'Intel', 'Agilent', 'Hertz', 'Exxon', 'Qualcomm', 'Costco', 'Chevron', 'Kellogg', 'SanDisk', 'Estee', 'Lauder', 'Goodyear', 'Walmart', 'Phillips', 'Comcast', 'Amazon', 'Google', 'CocaCola', 'FedEx', 'Goldman', 'Sears', 'DuPont', 'Warner', 'McDonalds', 'Nike', 'Kraft', 'Colgate', 'Apache', 'Chubb', 'Avis', 'BARNES', 'Hershey', 'Mattel', 'Facebook', 'fb']

cities = ["York","Los","Angeles","Chicago","Houston","Philadelphia","Phoenix","Antonio","Diego","Dallas","Jose","Austin","Jacksonville","Indianapolis","Francisco","Detroit","Memphis","Boston","Seattle","Denver","Washington","Baltimore","Vegas","Kansas","Virginia","Colorado","Atlanta","Miami","Oakland","Minneapolis","Cleveland","Sacramento"]
